...
/**
 * @ngdoc function
 * @name transxelaWebApp.controller:DuenioCalendariopilotoCtrl
 * @description
 * # DuenioCalendariopilotoCtrl
 * Controller of the transxelaWebApp
 */
 angular.module('transxelaWebApp').controller('DuenioCalendariopilotoCtrl', function ($scope, apiService, $uibModal, $location, $cookies) {
   ...
   $scope.showVerModificar = function (evento) {
     ...
     uibModalInstance.result.then(function (result) {
       if(result.chofer === $scope.idchofer){
           ...
           for(var i = 0; i < horariosdetalle.length; i++) {
             ...
             if(fechaActual.getTime()<fInicio.getTime()){
               ...
               $scope.events.push({
                 ...
                 idpiloto: $scope.piloto.idchofer,
