 ...
 */
angular.module('transxelaWebApp').controller('DuenioHorariosCtrl', function($scope, $http, $uibModal, $location, $cookies) {
  ...
  $scope.gridOptions = {};
  var res = $http.get($scope.apiurl+'/duenio/'+$scope.idduenio+'/'+'f02472ca6c3684ed0954370161e168fbdf31a8da'+'/horarios');
