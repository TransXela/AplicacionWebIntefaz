...
angular.module('transxelaWebApp').controller('crearCulturaController', ['$scope', '$http', '$uibModalInstance', 'options', 'apiService', 'grupos', function ($scope, $http, $uibModalInstance, options, apiService, grupos) {
  $scope.nombre = null;
...
angular.module('transxelaWebApp').controller('VerModificarCulturaController', ['$scope', '$resource', '$uibModalInstance', 'options', 'culturausu', 'apiService', 'grupos', function ($scope, $resource, $uibModalInstance, options, culturausu, apiService, grupos) {
